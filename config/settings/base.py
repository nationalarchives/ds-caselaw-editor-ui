...
MIGRATION_MODULES = {"sites": "ds_caselaw_editor_ui.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "config.clacks_middleware.ClacksOverheadMiddleware",
...
EDITORS_GROUP_ID = env("EDITORS_GROUP_ID", default=None)
