...
awslocal sns create-topic --name event-hub

awslocal sns subscribe --topic-arn arn:aws:sns:us-east-1:000000000000:event-hub --protocol sqs --notification-endpoint arn:aws:sns:us-east-1:000000000000:dummy-queue | jq '.SubscriptionArn' | sed s/\"//g
