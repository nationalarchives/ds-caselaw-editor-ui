        ...
        for version in sorted_ml_versions:
            ...
            try:
                ...
                if structured_data["type"] == VersionType.SUBMISSION.value:
                    ...
                    if submission:
                        context["structured_history"].append(submission)
                ...
                if (
                    ...
                    event_object["agent"] = structured_data["payload"]["submitter"][
                        "name"
                    ]
                    event_object["agent_email"] = structured_data["payload"][
                        "submitter"
                    ]["email"]
            ...
            # Catch both a TypeError (this thing has no annotation) and JSON Decode (it's not structured)
                ...
                submission_sequence_number += 1
                context["structured_history"].append(
                    {
                        "type": "legacy",
